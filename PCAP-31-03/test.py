...
my_car_list[6:-1] = [
    "Ford Focus",
    "Dodge Charger",
]  # Assign values to indexes 6 and 7/-1
print(my_car_list)
print(my_car_list[::-1])
...
int_dict = {1: "ONE", 2: "TWO", 3: "Three", 3: "THREE"}
...
fruit_qty_consumed = {"Plum": {"Fri": 70, "Sat": 80}, "Apple": {"Fri": 90, "Sat": 95}}
...
fruits = {"Banana": (50, 60, 40, 55), "Avocado": (30, 50, 40, 45)}
...
def check_file_args(filename):
    if not os.path.isfile(filename):
        raise FileNotFoundError(
            errno.ENOENT, os.strerror(errno.ENOENT), filename, 2, "filename2"
        )
